...
#> ℹ Info [27/02/2026 - 10:41:06]:  Message for general information
```
...
#> ! Warning [27/02/2026 - 10:41:06]:  Warning message
```
...
#> ✖ Error [27/02/2026 - 10:41:06]:  Error message
```
...
#> [1] "DEBUG [2026-02-27 10:41:06] Message for debugging purposes"
#> [2] "INFO [2026-02-27 10:41:06] Message for general information"
#> [3] "WARN [2026-02-27 10:41:06] Warning message"                
#> [4] "ERROR [2026-02-27 10:41:06] Error message"
```
...
#> ℹ Info [27/02/2026 - 10:41:06]:  Some useful information taking advantage of `logger`
Sys.sleep(2)
logInfo("First logging example done [{.field {toc(t0, 's')}}]", type = "success")
#> ✔ Info [27/02/2026 - 10:41:08]:  First logging example done [2.0 s]
```
...
#> [3] "WARN [2026-02-27 10:41:06] Warning message"                                     
#> [4] "ERROR [2026-02-27 10:41:06] Error message"                                      
#> [5] "DEBUG [2026-02-27 10:41:06] A logging example"                                  
#> [6] "INFO [2026-02-27 10:41:06] Some useful information taking advantage of `logger`"
#> [7] "SUCCESS [2026-02-27 10:41:08] First logging example done [2.0 s]"
```
...
#> ! Warning [27/02/2026 - 10:41:09]:  Warning example about "x" !
...
#>  [6] "INFO [2026-02-27 10:41:06] Some useful information taking advantage of `logger`"
#>  [7] "SUCCESS [2026-02-27 10:41:08] First logging example done [2.0 s]"               
#>  [8] "WARN [2026-02-27 10:41:09] Warning example about \"x\" !"                       
#>  [9] "\"x\" is of class `numeric` and length 1"                                       
#> [10] "The 1 value of \"x\" is: 10"                                                    
#> [11] "WARN [2026-02-27 10:41:09] Warning example about \"x\" !"                       
...
#> 
#> ── Testing `logCatch()` ────────────────────────────────────────────────────────
#> ! Warning [27/02/2026 - 10:41:09]:  Warning about "x" !
...
#> ✔ Info [27/02/2026 - 10:41:09]:  Warning message was caught
```
...
#> [12] "\"x\" is of class `character` and length 4"                                                                 
#> [13] "The 4 values of \"x\" are: \"e\", \"f\", \"g\", and \"h\""                                                  
#> [14] "DEBUG [2026-02-27 10:41:09] Testing `logCatch()`"                                                           
#> [15] "WARN [2026-02-27 10:41:09] Warning about \"x\" !"                                                           
...
#> [18] "SUCCESS [2026-02-27 10:41:09] Warning message was caught"
```
...
#> ! Warning [27/02/2026 - 10:41:09]:  This is a useful message that I want displayed
```
...
#> [17] "The 3 values of \"x\" are: \"This is a string\", \"This is another string\", and \"This is a third string\""
#> [18] "SUCCESS [2026-02-27 10:41:09] Warning message was caught"                                                   
#> [19] "DEBUG [2026-02-27 10:41:09] This is a not useful message that is warned by another package"                 
#> [20] "WARN [2026-02-27 10:41:09] This is a useful message that I want displayed"
```
